...
#include <algorithm>
#include <set>
/*#include "topleftshift.cpp"
#include "bottomLeftshift.cpp"
#include "topRightshift.cpp"
#include "bottomRightshift.cpp"*/
#define TOP_LEFT_LAT 40.99-0.005525
#define TOP_LEFT_LONG -74.276+0.0074375
...
int main ()
{
    ...
    for(int i = 0; i < noOfSmallerPartitions; i++)
    {
        cout << endl << endl  << endl;
        cout << "Top left coordinates: " << box[i].p_id.top_left.latitude << ", " << box[i].p_id.top_left.longitude << endl;
        cout << "Top right coordinates: " << box[i].p_id.top_right.latitude << ", " << box[i].p_id.top_right.longitude << endl;
        cout << "Bottom left coordinates: " << box[i].p_id.bottom_left.latitude << ", " << box[i].p_id.bottom_left.longitude << endl;
        cout << "Bottom right coordinates: " << box[i].p_id.bottom_right.latitude << ", " << box[i].p_id.bottom_right.longitude << endl;
    }
